    ...
    <section style={{ backgroundColor: '#ffffff', padding: isMobile ? '32px 0 40px' : '60px 0 80px' }}>
      ...
      {isMobile ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px', padding: '0 8px' }}>
          ...
          <div style={{ width: '100%', backgroundColor: '#000000', borderRadius: '20px', padding: '28px 24px' }}>
            <p style={{
              fontFamily: 'Inter, sans-serif', fontSize: '15px', fontWeight: 700,
              lineHeight: '1.8', color: '#ffffff', textAlign: 'justify',
            }}>
              <span style={{ fontWeight: 900, color: '#F3CD00' }}>X Pact Ventures</span>{' '}
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', maxWidth: '1300px', margin: '0 auto', padding: '0 40px', gap: '50px' }}>
          ...
          <div style={{ flex: '1', backgroundColor: '#000000', borderRadius: '28px', padding: '44px 50px' }}>
